		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Third App",
									"targetURL": "#comlab2devthirdapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devthirdapp-display": {
								"semanticObject": "comlab2devthirdapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.thirdapp",
									"url": sap.ui.require.toUrl("com/lab2dev/thirdapp")
								}
							}
						}
					}
